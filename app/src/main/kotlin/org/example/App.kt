...
fun main() {
    ...
    //Maneja la interacción con el usuario (es un object singleton - un patrón de diseño que garantiza que una clase tenga solo una instancia en toda la aplicación y provee un punto de acceso global a ella)
